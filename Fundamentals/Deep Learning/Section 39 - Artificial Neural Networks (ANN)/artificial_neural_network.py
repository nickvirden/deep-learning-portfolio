...
# GPU can run more floating point calculations and parallel calculations than a CPU

# Install Theano
# pip install --upgrade --no-deps git+git://github.com/Theano/Theano.git
# Theano is a numerical computations library that is based on numpy syntax

# Install Tensorflow
# pip install --upgrade tensorflow

# Theano and Tensorflow are good for research if you want to build a neural network from scratch
