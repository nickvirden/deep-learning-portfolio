...
# Kernel PCA (kPDA)
# When the data is non-linearly separable, we need to map the data to a higher dimension to separate it
from sklearn.decomposition import KernelPCA

# Takes the components that help us discriminate classes the most
