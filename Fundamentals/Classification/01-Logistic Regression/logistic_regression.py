...
independent_variable_columns = [2, 3]
dependent_variable_columns = 4
X = dataset.iloc[:, independent_variable_columns].values
y = dataset.iloc[:, dependent_variable_columns].values
